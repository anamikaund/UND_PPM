...
body {
	height: 100%;
	margin: 0;
	background: url(assets/img/undclifford.jpg);
...
<body>
	<div class="navbar navbar-default">
		...
		<div class="navbar-collapse collapse navbar-responsive-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="/undppm">Home</a></li>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<img src="assets/img/spaceStudiesLogo.jpg" alt="UND Space Studies" height="150" width="570">
				<h1>Welcome to University of North Dakota's Plant Production Assembly Module!</h1>
