...
<title>University of North Dakota - User Enrollment Signup</title>
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Please fill in your details below to complete the registration</h1>
				<p>We recommend using UND Mail!</p>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							...
							<fieldset>
								<legend>User Enrollment Signup</legend>
